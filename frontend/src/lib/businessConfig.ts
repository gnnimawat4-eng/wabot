...
export const BUSINESS_TYPES: BusinessConfig[] = [
  ...
  },
  {
    ...
    nav: [
      { href: '/dashboard', label: 'Dashboard', emoji: '📊' },
      { href: '/coming-soon?feature=Properties', label: 'Properties', emoji: '🏠' },
      { href: '/coming-soon?feature=Site+Visits', label: 'Site Visits', emoji: '📅' },
      { href: '/coming-soon?feature=Leads', label: 'Leads', emoji: '🎯' },
      { href: '/contacts', label: 'Contacts', emoji: '👥' },
      { href: '/flows', label: 'Flows', emoji: '🤖' },
      { href: '/broadcasts', label: 'Broadcasts', emoji: '📢' },
      { href: '/inbox', label: 'Inbox', emoji: '📥' },
  ...
  },
  {
    ...
    nav: [
      { href: '/dashboard', label: 'Dashboard', emoji: '📊' },
      { href: '/coming-soon?feature=Appointments', label: 'Appointments', emoji: '📅' },
      { href: '/coming-soon?feature=Services', label: 'Services', emoji: '💇' },
      { href: '/coming-soon?feature=Staff', label: 'Staff', emoji: '👨‍💼' },
      { href: '/contacts', label: 'Contacts', emoji: '👥' },
      { href: '/flows', label: 'Flows', emoji: '🤖' },
      { href: '/broadcasts', label: 'Broadcasts', emoji: '📢' },
      { href: '/inbox', label: 'Inbox', emoji: '📥' },
  ...
  },
  {
    ...
    nav: [
      { href: '/dashboard', label: 'Dashboard', emoji: '📊' },
      { href: '/coming-soon?feature=Appointments', label: 'Appointments', emoji: '📅' },
      { href: '/coming-soon?feature=Patients', label: 'Patients', emoji: '🏥' },
      { href: '/coming-soon?feature=Services', label: 'Services', emoji: '💊' },
      { href: '/contacts', label: 'Contacts', emoji: '👥' },
      { href: '/flows', label: 'Flows', emoji: '🤖' },
      { href: '/broadcasts', label: 'Broadcasts', emoji: '📢' },
  ...
  },
  {
    ...
    nav: [
      { href: '/dashboard', label: 'Dashboard', emoji: '📊' },
      { href: '/coming-soon?feature=Classes', label: 'Classes', emoji: '📚' },
      { href: '/coming-soon?feature=Students', label: 'Students', emoji: '🎓' },
      { href: '/coming-soon?feature=Fees', label: 'Fees', emoji: '💰' },
      { href: '/contacts', label: 'Contacts', emoji: '👥' },
      { href: '/flows', label: 'Flows', emoji: '🤖' },
      { href: '/broadcasts', label: 'Broadcasts', emoji: '📢' },
      { href: '/inbox', label: 'Inbox', emoji: '📥' },
  ...
  },
  {
    ...
    nav: [
      { href: '/dashboard', label: 'Dashboard', emoji: '📊' },
      { href: '/coming-soon?feature=Vehicles', label: 'Vehicles', emoji: '🚗' },
      { href: '/coming-soon?feature=Test+Drives', label: 'Test Drives', emoji: '🏎️' },
      { href: '/coming-soon?feature=Service+Booking', label: 'Service', emoji: '🔧' },
      { href: '/contacts', label: 'Contacts', emoji: '👥' },
      { href: '/flows', label: 'Flows', emoji: '🤖' },
      { href: '/broadcasts', label: 'Broadcasts', emoji: '📢' },
      { href: '/inbox', label: 'Inbox', emoji: '📥' },
